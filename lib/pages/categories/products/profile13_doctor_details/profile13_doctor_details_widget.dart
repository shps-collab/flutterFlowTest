                                  ...
                                  Expanded(
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                                  ...
                                                  builder:
                                                    ...
                                                    return AlertDialog(
                                                      title: Text(
                                                          'Confirm Send Email'),
                                                      content: Text(
                                                          'Would you like to email Pet and Playground Products regarding this product?'),
                                                      actions: [
                                                        TextButton(
                                                          onPressed: () =>
                                                              Navigator.pop(
                                        ...
                                        await launchUrl(Uri(
                                            scheme: 'mailto',
                                            path: 'joshkoopman240@gmail.com',
                                            query: {
                                              'subject':
                                                  'Inquiry for Kylie\'s Cross',
                                              'body':
                                                  'You have received an inquiry for Kylie\'s Cross.',
                                            }
                                                .entries
